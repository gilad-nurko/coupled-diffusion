...
def add_argparse_args(parser: ArgumentParser):
    ...
    parser.add_argument("--logits_pretrain_ckpt", type=str,
                        default="/mlspeech/data/gilad/logs/ASR_diffusion_ears/wham/with_logits/logits_model_pretrain_width_768_lr_1e-4_score_pred_residual_model_complex_audio_and_prev_logits_baseline_weight.pt")
    ...
    parser.add_argument("--transcripts_path", type=str, default="/mlspeech/data/gilad/paper_ears_wham/transcripts.json")
