...
class WhisperGuidedScoreModel(pl.LightningModule):
    ...
    def __init__(
        ...
        whisper_name="base", guidance_scale=1.0, distillation_weight=1.0, logits_weight=1.0, **kwargs
    ):
        """
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if batch_idx == 0 and self.num_eval_files != 0:
            ...
            for i, (clean_file, noisy_file) in enumerate(zip(clean_files, noisy_files)):
                ...
                x_hat = self.enhance(y_tensor, kw_probs_cor, N=self.sde.N, snr=0.33) # added the kw_probs_cor for conditioning
                if self.sr != 16000:
