...
class Specs(Dataset):
    def __init__(self, data_dir, subset, dummy, shuffle_spec, num_frames,
            ...
            stft_kwargs=None, transcripts_path="/mlspeech/data/gilad/paper_ears_wham/transcripts.json", **ignored_kwargs):
...
class SpecsDataModule(pl.LightningDataModule):
    ...
    def add_argparse_args(parser):
        parser.add_argument("--base_dir", type=str, default="/mlspeech/data/gilad/paper_ears_wham/EARS-WHAM_v2_4sec_chunks", help="The base directory of the dataset. Should contain `train`, `valid` and `test` subdirectories, each of which contain `clean` and `noisy` subdirectories.")
        ...
        parser.add_argument("--transcripts_path", type=str, default="/mlspeech/data/gilad/paper_ears_wham/transcripts.json", help="Path to transcripts JSON mapping {category: transcript_str}.")
        return parser
    ...
    def setup(self, stage=None):
        specs_kwargs = dict(
            ...
            spec_transform=self.spec_fwd, transcripts_path=self.kwargs.get("transcripts_path",
                                                                           "/mlspeech/data/gilad/paper_ears_wham/transcripts.json"),
            **self.kwargs
        )
