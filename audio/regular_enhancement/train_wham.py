...
from sgmse.model_ears_without_logits import WhisperGuidedScoreModel
...
if __name__ == '__main__':
     ...
     for parser_ in (base_parser, parser):
          ...
          parser_.add_argument("--log_dir", type=str, default="/mlspeech/data/gilad/logs/ASR_diffusion_ears/wham/without_logits", help="Directory to save logs.")
